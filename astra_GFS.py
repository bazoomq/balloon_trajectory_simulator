...
#######################################################################
        ...
        self.windDirData, self.windSpeedData = data_matrices['ugrdprs'], data_matrices['vgrdprs']
        # Store results
    ...
    def fromFiles(cls, fileDict, lat, lon, date_time, HD=False, **kwargs):
        ...
        **kwargs : dict
        ...
        # Convert to KNOTS and the turn into direction and speed
        module.windDirData, module.windSpeedData = data_matrices['ugrdprs'], data_matrices['vgrdprs']
